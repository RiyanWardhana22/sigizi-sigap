        ...
        <div className="relative bg-[#080616]/60 backdrop-blur-xl border border-[#285A48]/30 rounded-3xl shadow-[0_0_40px_rgba(40,90,72,0.15)] overflow-hidden">
          ...
          <div className="px-8 pb-10">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="relative group">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  <FaShieldAlt className="text-slate-400 group-focus-within:text-emerald-400 transition-colors" />
                </div>
                <input
                  type="password"
                  className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-[#285A48] focus:border-transparent focus:bg-white/10 transition-all text-sm"
                  placeholder={t("login.sandiKonfirmasi")}
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-[#285A48] hover:bg-[#1d4235] disabled:opacity-60 disabled:cursor-not-allowed text-white font-bold py-3.5 px-4 rounded-xl shadow-[0_0_15px_rgba(40,90,72,0.4)] transition-all duration-300 mt-2 text-sm uppercase tracking-wider"
              >
                {isLoading ? t("inputWilayah.memproses") : t("login.register")}
              </button>
            </form>
