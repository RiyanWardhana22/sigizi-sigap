  ...
  const fetchData = async (userId) => {
    ...
    try {
      ...
      if (data.status === "success") {
        ...
        console.log(
          "Processed anak list:",
          validAnakList.map((a) => ({ id: a.id, nama: a.nama_anak })),
        );
                  ...
                  <div className="flex items-center gap-3">
                    {selectedAnakData ? (
                      ...
                      <>
                        <FontAwesomeIcon
                          icon={fas.faBaby}
                          className="text-sigizi-green text-xl"
                        />
                                ...
                                {anak.riwayat && anak.riwayat.length > 0 && (
                                  <div className="flex gap-3 text-xs text-gray-500 mt-1">
                                    <span>
                                      T:{" "}
                                      {
                                        anak.riwayat[anak.riwayat.length - 1]
                                          .tinggi_badan
                                      }{" "}
                                      cm
                                    </span>
          ...
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            ...
            <form onSubmit={handleAddAnak} className="space-y-4">
              ...
              <div className="flex gap-3">
                ...
                <button
                  type="submit"
                  className="flex-1 bg-sigizi-green text-white py-2 rounded-lg"
                >
                  Simpan
                </button>
              </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-xl max-w-md w-full p-6">
            <h2 className="text-xl font-bold mb-4">
              Update Pertumbuhan - {selectedAnakData.nama_anak}
            </h2>
