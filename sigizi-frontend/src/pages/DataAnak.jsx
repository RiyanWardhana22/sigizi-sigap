          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <div className="bg-gradient-to-br from-emerald-500 to-emerald-600 p-3 rounded-2xl shadow-lg shadow-emerald-200">
                <FontAwesomeIcon icon={fas.faUsers} className="text-2xl text-white" />
              </div>
              <div>
                <h1 className="text-2xl font-bold text-gray-800">Data Orang Tua & Anak</h1>
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-emerald-100 text-sm">Pilih orang tua untuk melihat data anak</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="p-5 border-b border-gray-100 bg-gray-50/50">
              <div className="flex flex-wrap gap-4 items-end">
                <div className="flex-1 min-w-[250px]">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Cari Orang Tua</label>
                  <div className="relative">
                    <FontAwesomeIcon icon={fas.faSearch} className="absolute left-4 top-1/2 -translate-y-1/2 text-gray-400" />
                    <input
                      type="text"
                ...
                <div className="w-64">
                  <label className="block text-xs font-semibold text-gray-500 uppercase tracking-wider mb-2">Filter Domisili</label>
                  <select
                    value={filterWilayah}
              ...
              <table className="w-full">
                <thead className="bg-gray-50/80 backdrop-blur-sm sticky top-0 z-10">
                  <tr>
                    ...
                    <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Domisili</th>
                  ...
                  {filteredOrangTua.length > 0 ? (
                    filteredOrangTua.map((ot, index) => (
                      ...
                      >
                          ...
                          <div className="flex items-center gap-3">
                            ...
                            <div>
                              <span className={`font-semibold text-sm ${
                                selectedOrangTuaId === ot.id ? "text-emerald-700" : "text-gray-800"
                              }`}>
                                {ot.nama_lengkap}
                              </span>
                            </div>
                        ...
                        <td className="px-6 py-4 text-sm text-gray-600">{ot.email}</td>
                        <td className="px-6 py-4">
                          <span className="inline-flex items-center gap-2 text-sm text-gray-600 bg-gray-100 px-3 py-1 rounded-full">
                            <FontAwesomeIcon icon={fas.faLocationDot} className="text-emerald-500 text-xs" />
                            {ot.nama_kabupaten || "-"}
                          </span>
                        </td>
                        <td className="px-6 py-4">
                          ...
                          >
                            {selectedOrangTuaId === ot.id ? "Terpilih" : "Pilih"}
                          </button>
                        </td>
                      </tr>
                    ))
                      ...
                      <td colSpan={5} className="px-6 py-16 text-center">
                        <div className="flex flex-col items-center">
                          <div className="bg-gray-100 p-6 rounded-full mb-4">
                            <FontAwesomeIcon icon={fas.faUsers} className="text-4xl text-gray-400" />
                          </div>
                          <p className="text-gray-500 font-medium">Tidak ada data orang tua</p>
                          <p className="text-gray-400 text-sm mt-1">Data akan muncul setelah ada pendaftaran</p>
                        </div>
                      </td>
                    </tr>
                  )}
              ...
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 px-7 py-5">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-blue-100 text-sm">Detail informasi orang tua terpilih</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-7">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mb-5">
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-blue-50 to-white rounded-xl border border-blue-100">
                    <div className="w-12 h-12 rounded-xl bg-blue-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faUser} className="text-blue-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Nama Lengkap</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.nama_lengkap}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-gray-50 to-white rounded-xl border border-gray-100">
                    <div className="w-12 h-12 rounded-xl bg-gray-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faEnvelope} className="text-gray-500 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Email</p>
                      <p className="font-bold text-gray-800 text-sm">{selectedOrangTuaData.email}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-emerald-50 to-white rounded-xl border border-emerald-100">
                    <div className="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faLocationDot} className="text-emerald-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Domisili</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.nama_kabupaten || "-"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-orange-50 to-white rounded-xl border border-orange-100">
                    <div className="w-12 h-12 rounded-xl bg-orange-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faCalendar} className="text-orange-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Tanggal Lahir</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.tanggal_lahir || "-"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 pt-5 border-t border-gray-100">
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-indigo-50 to-white rounded-xl border border-indigo-100">
                    <div className="w-12 h-12 rounded-xl bg-indigo-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faGraduationCap} className="text-indigo-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Pendidikan Ibu</p>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-emerald-50 to-white rounded-xl border border-emerald-100">
                    <div className="w-12 h-12 rounded-xl bg-emerald-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faMoneyBillWave} className="text-emerald-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Penghasilan</p>
                      <p className="font-bold text-gray-800 text-sm">
                        {selectedOrangTuaData.penghasilan_range ? `Rp ${selectedOrangTuaData.penghasilan_range}` : "-"}
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-cyan-50 to-white rounded-xl border border-cyan-100">
                    <div className="w-12 h-12 rounded-xl bg-cyan-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faDroplet} className="text-cyan-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Kualitas Air</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.kualitas_air || "-"}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-purple-50 to-white rounded-xl border border-purple-100">
                    <div className="w-12 h-12 rounded-xl bg-purple-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faToilet} className="text-purple-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Sanitasi</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.sanitasi || "-"}</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 mt-5 pt-5 border-t border-gray-100">
                  <div className="flex items-center gap-4 p-4 bg-gradient-to-br from-rose-50 to-white rounded-xl border border-rose-100">
                    <div className="w-12 h-12 rounded-xl bg-rose-100 flex items-center justify-center">
                      <FontAwesomeIcon icon={fas.faHospital} className="text-rose-600 text-lg" />
                    </div>
                    <div>
                      <p className="text-xs text-gray-500 font-medium">Akses Kesehatan</p>
                      <p className="font-bold text-gray-800">{selectedOrangTuaData.akses_kesehatan || "-"}</p>
                    </div>
                  </div>
                </div>
                ...
                {!selectedOrangTuaData.profil_lengkap && (
                  <div className="mt-4 p-4 bg-amber-50 rounded-xl border border-amber-200 flex items-center gap-3">
                    ...
                    <p className="text-sm text-amber-700 font-medium">Data profil orang tua ini belum lengkap</p>
                  </div>
                )}
              </div>
            </div>
                ...
                <div className="flex items-center justify-between flex-wrap gap-4">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-emerald-100 text-sm">{anakList.length} anak terdaftar</p>
                    </div>
                  </div>
                  {anakList.length > 0 && (
                    <div className="flex gap-3 flex-wrap">
                      <div className="relative">
                        <FontAwesomeIcon icon={fas.faSearch} className="absolute left-3 top-1/2 -translate-y-1/2 text-white/60 text-sm" />
                        <input
                          type="text"
              ...
              {anakList.length > 0 ? (
                <div className="overflow-auto max-h-[500px]">
                  <table className="w-full">
                    <thead className="bg-gray-50/80 backdrop-blur-sm sticky top-0 z-10">
                      <tr>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Anak</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tgl Lahir</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Umur</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">JK</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Tinggi</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Berat</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">L. Kepala</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Status Gizi</th>
                        <th className="px-6 py-4 text-left text-xs font-semibold text-gray-500 uppercase tracking-wider">Z-Score</th>
                      </tr>
                    </thead>
                    <tbody className="divide-y divide-gray-50">
                      {filteredAnak.length > 0 ? (
                        filteredAnak.map((anak) => {
                          ...
                          return (
                            ...
                            >
                              <td className="px-6 py-4">
                                <div className="flex items-center gap-3">
                                  <div className={`w-9 h-9 rounded-xl flex items-center justify-center text-white font-bold text-xs shadow-md ${
                                    selectedAnakId === anak.id
                                      ? "bg-gradient-to-br from-emerald-500 to-emerald-600"
                                      : "bg-gradient-to-br from-gray-400 to-gray-500"
                                  }`}>
                                  ...
                                  <span className={`font-semibold text-sm ${
                                    selectedAnakId === anak.id ? "text-emerald-700" : "text-gray-800"
                                  }`}>
                                    {anak.nama_anak}
                                  </span>
                                </div>
                              </td>
                              <td className="px-6 py-4 text-sm text-gray-600">{anak.tanggal_lahir}</td>
                              <td className="px-6 py-4 text-sm text-blue-600 font-semibold">{formatAge(anak.tanggal_lahir)}</td>
                              <td className="px-6 py-4">
                              ...
                              <td className="px-6 py-4 text-sm text-gray-600 font-medium">{lastRiwayat?.tinggi_badan || "-"} cm</td>
                              <td className="px-6 py-4 text-sm text-gray-600 font-medium">{lastRiwayat?.berat_badan || "-"} kg</td>
                              <td className="px-6 py-4 text-sm text-gray-600 font-medium">{lastRiwayat?.lingkar_kepala || "-"} cm</td>
                              <td className="px-6 py-4">
                                {lastRiwayat?.status_gizi ? (
                                  <span className={`inline-flex items-center gap-1.5 px-3 py-1.5 rounded-full text-xs font-bold border ${getStatusBadge(lastRiwayat.status_gizi)}`}>
                              ...
                              <td className="px-6 py-4 text-sm text-gray-600 font-medium">{lastRiwayat?.z_score || "-"}</td>
                            </tr>
                          );
                        })
                      ) : (
                        <tr>
                          <td colSpan={9} className="px-6 py-16 text-center">
                            <div className="flex flex-col items-center">
                              <div className="bg-gray-100 p-6 rounded-full mb-4">
                                <FontAwesomeIcon icon={fas.faBaby} className="text-4xl text-gray-400" />
                              </div>
                              <p className="text-gray-500 font-medium">Tidak ada anak dengan filter yang dipilih</p>
                            </div>
                          </td>
                        </tr>
                      )}
                ...
                <div className="p-16 text-center">
                  <div className="bg-gray-100 p-6 rounded-full inline-flex mb-4">
                    <FontAwesomeIcon icon={fas.faBaby} className="text-5xl text-gray-400" />
                  </div>
                  <p className="text-gray-500 font-medium">Belum ada data anak untuk orang tua ini</p>
                  <p className="text-gray-400 text-sm mt-1">Pilih orang tua lain atau tambahkan data anak</p>
                </div>
              )}
            </div>
          )}
          ...
          {!selectedOrangTuaId && (
            <div className="bg-gradient-to-br from-emerald-50 to-blue-50 rounded-2xl p-12 text-center border border-emerald-100">
              <div className="bg-white p-6 rounded-full inline-flex mb-6 shadow-md">
                <FontAwesomeIcon icon={fas.faHandPointer} className="text-5xl text-emerald-400" />
              </div>
              <p className="text-gray-700 font-bold text-lg">Pilih orang tua dari tabel di atas</p>
              <p className="text-gray-500 mt-2">Klik tombol "Pilih" pada baris orang tua untuk melihat data anak</p>
            </div>
          )}
        </main>
      </div>
